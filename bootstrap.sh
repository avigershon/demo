...
helm install --name schema-registry --set kafkaStore.overrideBootstrapServers=PLAINTEXT://kafka-kafka-headless:9092 --set kafka.enabled=false incubator/schema-registry
